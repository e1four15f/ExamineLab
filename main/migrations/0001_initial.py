# Generated by Django 2.2 on 2019-05-12 14:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='courses',
            field=models.ManyToManyField(through='main.UserCourseParticipation', to='main.Course'),
        ),
        #migrations.AddField(
        #    model_name='user',
        #    name='global_permission_groups',
        #    field=models.ManyToManyField(to='main.PermissionGroup'),
        #),
        #migrations.AddField(
        #    model_name='user',
        #    name='groups',
